  ...
  return (
    <div>
      ...
      <ul className="list-inside space-y-1">
        <li>
          <span className="text-[0.6875rem] font-[700] text-white">{t('step1.title')}</span>
          {' '}
          {t('step1.description')}
        </li>
        <li>
          <span className="text-[0.6875rem] font-[700] text-white">{t('step2.title')}</span>
          {' '}
          {t('step2.description')}
        </li>
        <li>
          <span className="text-[0.6875rem] font-[700] text-white">{t('step3.title')}</span>
          {' '}
          {t('step3.description')}
        </li>
        <li className="no-bullet translate-x-3">
          <span className="text-[0.6875rem] font-[700] text-white">{t('step4.title')}</span>
          {' '}
          {t('step4.description')}
        </li>
      </ul>
